# 2016.05.01 15:21:15 Støední Evropa (letní èas)
...
class VehicleDamageInfoPanel(object):
    ...
    def __onVehicleFeedbackReceived(self, eventID, vehicleID, value):
        if eventID == _EVENT_ID.SHOW_VEHICLE_DAMAGES_DEVICES:
            ...
            self.__hide()
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\gui\scaleform\daapi\view\battle\damage_info_panel.pyc 
