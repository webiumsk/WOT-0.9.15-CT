# 2016.05.01 15:22:05 Støední Evropa (letní èas)
...
class CarouselFalloutFilterOld(CarouselFilterOld):
    ...
    def getDefaultCriteria(self):
        return REQ_CRITERIA.INVENTORY
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\gui\scaleform\daapi\view\lobby\hangar\tank_carousel_filter.pyc 
